...
1. Target component includes a license file and a seperate PATENTS file that grants additional patent rights.  Curate the declared field with the license and add "AND `OTHER`". 
